...
void setup()
{
    ...
    pinMode(MD3, OUTPUT);
    pinMode(MD4, OUTPUT);
    digitalWrite(MD1, ofv);
    digitalWrite(MD2, ofv);
    digitalWrite(MD3, ofv);
    digitalWrite(MD4, ofv);
    ...
    if (WiFi.status() == WL_CONNECTED)
    {
        ...
        if (Firebase.ready())
        {
            ...
            k = fbdo.to<String>();
            ind1 = k.indexOf(',');
            m1 = k.substring(1, ind1);
            M1 = m1.toInt();
            MS1[0] = M1;
            EEPROM.write(40, MS1[0]);
            ind2 = k.indexOf(',', ind1 + 1);
            m2 = k.substring(ind1 + 1, ind2);
            M2 = m2.toInt();
            MS1[1] = M2;
            EEPROM.write(41, MS1[1]);
            ind3 = k.indexOf(']', ind2 + 1);
            m3 = k.substring(ind2 + 1, ind3);
            M3 = m3.toInt();
            MS1[2] = M3;
            EEPROM.write(42, MS1[2]);
            ...
            M1 = m1.toInt();
            MS2[0] = M1;
            EEPROM.write(20, MS2[0]);
            ind2 = k.indexOf(',', ind1 + 1);
            m2 = k.substring(ind1 + 1, ind2);
            M2 = m2.toInt();
            MS2[1] = M2;
            EEPROM.write(21, MS2[1]);
            ind3 = k.indexOf(']', ind2 + 1);
            m3 = k.substring(ind2 + 1, ind3);
            M3 = m3.toInt();
            MS2[2] = M3;
            EEPROM.write(22, MS2[2]);
            ...
            M1 = m1.toInt();
            MS3[0] = M1;
            EEPROM.write(30, MS3[0]);
            ind2 = k.indexOf(',', ind1 + 1);
            m2 = k.substring(ind1 + 1, ind2);
            M2 = m2.toInt();
            MS3[1] = M2;
            EEPROM.write(31, MS3[1]);
            ind3 = k.indexOf(']', ind2 + 1);
            m3 = k.substring(ind2 + 1, ind3);
            M3 = m3.toInt();
            MS3[2] = M3;
            EEPROM.write(32, MS3[2]);
            ...
            Firebase.getString(fbdo, "T/AH1");
            iv = fbdo.to<String>();
            AH1 = iv.toInt();
            EEPROM.write(10, AH1);
            Firebase.getString(fbdo, "T/AM1");
            iv = fbdo.to<String>();
            AM1 = iv.toInt();
            EEPROM.write(11, AM1);
            if ((AM1 + rt) == 60)
            ...
            Firebase.getString(fbdo, "T/AH2");
            iv = fbdo.to<String>();
            AH2 = iv.toInt();
            EEPROM.write(12, AH2);
            Firebase.getString(fbdo, "T/AM2");
            iv = fbdo.to<String>();
            AM2 = iv.toInt();
            EEPROM.write(13, AM2);
            if ((AM2 + rt) == 60)
            ...
            Firebase.getString(fbdo, "T/AH3");
            iv = fbdo.to<String>();
            AH3 = iv.toInt();
            EEPROM.write(14, AH3);
            Firebase.getString(fbdo, "T/AM3");
            iv = fbdo.to<String>();
            AM3 = iv.toInt();
            EEPROM.write(15, AM3);
            if ((AM3 + rt) == 60)
    ...
    else
    {
        ...
        {
            Serial.println("Reading from EEPROM 4");
            MS1[0] = EEPROM.read(40);
            MS1[1] = EEPROM.read(41);
            MS1[2] = EEPROM.read(42);
        }
        // MS2
        ...
        {
            Serial.println("Reading from EEPROM 5");
            MS2[0] = EEPROM.read(20);
            MS2[1] = EEPROM.read(21);
            MS2[2] = EEPROM.read(22);
        }
        // MS3
        ...
        {
            Serial.println("Reading from EEPROM 6");
            MS3[0] = EEPROM.read(30);
            MS3[1] = EEPROM.read(31);
            MS3[2] = EEPROM.read(32);
        }
    } // no net end
    EEPROM.commit();
    ...
    Serial.print("Repeat Alarm1-  ");
    Serial.print(AHR1);
    Serial.print(":");
    Serial.println(AMR1);
    Serial.print("Repeat Alarm2-  ");
    Serial.print(AHR2);
    Serial.print(":");
    Serial.println(AMR2);
    Serial.print("Repeat Alarm3-  ");
    Serial.print(AHR3);
    Serial.print(":");
    Serial.println(AMR3);
...
void work()
{
    ...
    {
        digitalWrite(MD4, onv);
        myDFPlayer.play(9);
        delay(1500);
        Serial.println(" Medicine4");
    }
}
